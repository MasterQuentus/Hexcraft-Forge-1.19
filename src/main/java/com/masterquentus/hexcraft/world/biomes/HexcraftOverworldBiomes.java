...
public class HexcraftOverworldBiomes
{
    @Nullable
    ...
    public static Biome whisperingforest()
    {
    ...
    public static Biome vampireforest()
    {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    public static Biome hellfungleforest()
    {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.desertSpawns(spawnBuilder);
    ...
    public static Biome echofungleforest()
    {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.desertSpawns(spawnBuilder);
    ...
    public static Biome crimsondesert()
    {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.desertSpawns(spawnBuilder);
    ...
    public static Biome fairyforest()
    {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.desertSpawns(spawnBuilder);
