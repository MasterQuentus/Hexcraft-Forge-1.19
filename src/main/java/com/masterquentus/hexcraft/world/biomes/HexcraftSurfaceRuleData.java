...
public class HexcraftSurfaceRuleData {
    public class TestSurfaceRuleData {
        ...
        protected static SurfaceRules.RuleSource makeRules() {
            ...
            return SurfaceRules.sequence(
                    SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.WHISPERING_FOREST), PODZOL),
                    SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.VAMPIRE_FOREST), GRASS_BLOCK),
