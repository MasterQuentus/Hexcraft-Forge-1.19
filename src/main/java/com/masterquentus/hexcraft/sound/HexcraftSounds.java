...
public class HexcraftSounds {
    ...
    public static final RegistryObject<SoundEvent> FAIRY_HURT = registerSoundEvent("fairy_hurt");
    public static final RegistryObject<SoundEvent> FAIRY_AMBIENT = registerSoundEvent("fairy_ambient");
    public static final RegistryObject<SoundEvent> FAIRY_DEATH = registerSoundEvent("fairy_death");


    private static RegistryObject<SoundEvent> registerSoundEvent(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Hexcraft.MOD_ID, name)));
    }
