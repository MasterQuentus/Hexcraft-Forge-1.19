...
public class VampireVindicatorEntity  extends Pillager implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public VampireVindicatorEntity (EntityType<? extends Pillager> entityType, Level level) {
