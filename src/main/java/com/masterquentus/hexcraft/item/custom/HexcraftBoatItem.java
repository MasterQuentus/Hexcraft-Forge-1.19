...
public class HexcraftBoatItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                HexcraftBoatEntity boat = this.getBoat(level, hitresult);
                boat.setWoodType(this.type.getName());
    ...
    private HexcraftBoatEntity getBoat(Level level, HitResult hitResult) {
        return new HexcraftBoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z);
    }
}
